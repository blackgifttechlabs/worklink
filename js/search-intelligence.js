(function searchIntelligenceBootstrap(root, factory) {
  ...
  const SEARCH_ALIASES = [
    ['maid', 'Housekeeper', 'Housekeeper'],
    ['house maid', 'Housekeeper', 'Housekeeper'],
    ['cleaner', 'Domestic Cleaner', 'Domestic Cleaner'],
    ['house cleaning', 'Domestic Cleaner', 'Domestic Cleaner'],
    ['capender', 'Carpenter', 'Carpenter'],
    ['capenter', 'Carpenter', 'Carpenter'],
    ['carpender', 'Carpenter', 'Carpenter'],
    ['wood work', 'Carpenter', 'Carpenter'],
    ['woodwork', 'Carpenter', 'Carpenter'],
    ['garden', 'Landscaper', 'Landscaper'],
    ['gardens', 'Landscaper', 'Landscaper'],
    ['gardener', 'Landscaper', 'Landscaper'],
    ['lawn', 'Landscaper', 'Landscaper'],
    ['mowing', 'Landscaper', 'Landscaper'],
    ['fix pipes', 'Plumber', 'Plumber'],
    ['blocked drain', 'Plumber', 'Plumber'],
    ['geyser', 'Plumber', 'Plumber'],
    ['wiring', 'Electronics Technician', 'Electronics Technician'],
    ['solar', 'Solar Installer', 'Solar Installer'],
    ['power backup', 'Battery Technician', 'Battery Technician'],
    ['build wall', 'Builder', 'Builder'],
    ['web site', 'Software Programmer', 'Software Programmer'],
    ['website', 'Software Programmer', 'Software Programmer'],
    ['app', 'Software Programmer', 'Software Programmer'],
    ['computer repair', 'IT Specialist', 'IT Specialist'],
    ['phone repair', 'Electronics Technician', 'Electronics Technician'],
    ['make up', 'Nail Technician', 'Nail Technician'],
    ['makeup', 'Nail Technician', 'Nail Technician'],
    ['nails', 'Nail Technician', 'Nail Technician'],
    ['moving', 'Furniture Remover', 'Furniture Remover'],
    ['truck', 'Loader/Unloader', 'Loader/Unloader'],
    ['taxi', 'Taxi Driver', 'Taxi Driver'],
    ['wedding photos', 'Photographer', 'Photographer'],
    ['photos', 'Photographer', 'Photographer'],
    ['maths', 'Tutor', 'Tutor'],
    ['math', 'Tutor', 'Tutor'],
    ['nanny', 'Babysitter', 'Babysitter'],
    ...
    ['borehole', 'Borehole Driller', 'Borehole Driller'],
